...
async def for_uz_lang(msg : types.Message):
    change_leng = 'uz'
    await msg.bot.send_photo(chat_id=msg.chat.id,caption="📖 Menyular",photo="https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8Nnx8fGVufDB8fHx8&w=1000&q=80")
...
async def for_ru_lang(msg : types.Message):
    change_leng = "ru"
    await msg.answer("Menyu for ruscha")
    await All_states.change_foods.set()
